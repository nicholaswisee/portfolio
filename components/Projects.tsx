                ...
                <div className={isCompact ? "mb-8" : "mb-12 md:mb-16"}>
                    ...
                    <p className="mt-4 max-w-2xl text-muted">
                        {isCompact
                            ...
                            : "Three projects that define what I build: production platforms with real users, systems from the ground up, and a genuine approach to building efficient systems."}
                    </p>
                </div>
                ...
                {isCompact ? (
                    <ol className="compact-project-list">
                        {[...selectedWork, ...projectArchive].map((project) => (
                            <li key={project.name} data-compact-project-row="true">
